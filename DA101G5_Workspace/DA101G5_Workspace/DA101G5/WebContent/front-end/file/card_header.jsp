...
<%@ page import="java.util.*"%>
	<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light d-flex">
		<a class="navbar-brand" href="#">DA101G5</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
        		...
        		<div class="dropdown-menu" aria-labelledby="navbarDropdown">
         				<a class="dropdown-item" href="<%=request.getContextPath()%>/front-end/card/select_page.jsp">Select Card</a>
          				<a class="dropdown-item" href="<%=request.getContextPath()%>/front-end/card/listAllCard.jsp">List All</a>
         				<a class="dropdown-item" href="<%=request.getContextPath()%>/front-end/card/addCard.jsp">Add Card</a>
       			 </div>
     		     </li>
