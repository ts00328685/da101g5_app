...
<table>
	...
	<tr>
		<td>對方會員編號:</td>
		<td><input type="TEXT" name="member_id2" size="45"	value="<%=messageVO.getMember_id2()%>" /></td>
	</tr>
	<tr>
		<td>訊息日期:</td>
	...
	<tr>
		<td>訊息內容:</td>
		<td><input type="TEXT" name="memmsg_ent" size="45"	value="<%=messageVO.getMemmsg_ent()%>" /></td>
	</tr>
	<tr>
		<td>訊息狀態:</td>
		<td><input type="TEXT" name="memmsg_state" size="45" value="<%=messageVO.getMemmsg_state()%>" /></td>
	</tr>
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=messageVO.getMemmsg_date()%>', // value:   new Date(),
