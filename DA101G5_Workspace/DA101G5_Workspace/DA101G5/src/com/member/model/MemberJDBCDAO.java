...
//				"INSERT INTO member (member_id, mem_name, mem_email, mem_pwd, mem_nick, mem_sex, mem_city, mem_country,  mem_mobile, mem_birthday,mem_createtime, mem_pic ) VALUES ('M'||LPAD(to_char(MEM_SEQ.NEXTVAL), 5, '0'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
//				"UPDATE member set mem_name=?, mem_pwd=?, mem_email=?, mem_nick=?, mem_birthday=?, mem_mobile=?, mem_city=?, mem_country=?, mem_profile=?, mem_pic=? where member_id = ?";
...
//			pstmt.setString(5, memberVO.getMem_sex());
//			pstmt.setString(6, memberVO.getMem_city());
//			pstmt.setString(7, memberVO.getMem_country());
//			pstmt.setString(8, memberVO.getMem_mobile());
//			
...
//			
//			
//			pstmt.setDate(9, memberVO.getMem_birthday());
//			pstmt.setDate(10, memberVO.getMem_createtime());
//			pstmt.setBytes(11, memberVO.getMem_pic());
//
//			pstmt.executeUpdate();
//
...
//			System.out.println(aMember.getMem_createtime() + ",");
//			System.out.print(aMember.getMem_pic());
//			System.out.println();
//		}	
//	}
//}
