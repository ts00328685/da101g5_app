...
public class CommodityDAO implements CommodityDAO_interface {
	...
	private static final String INSERT_STMT = "Insert into commodity "
			...
			+ " trandate, com_status, e_score, e_pol_statistics, e_des, com_detail) values "
	...
	private static final String UPDATE = "UPDATE commodity set member_id=?, com_description=?, "
			+ "com_pic=?, com_download=?, com_price=?, trandate=?, com_status=?, e_score=?, e_pol_statistics=?, e_des=?, com_detail=? "
			+ " where com_id = ?";
...
//	}
	...
	public static void main(String[] args) {
		...
		commodityVO1.setCom_description("�蝷�����儔嚗����瘨菔����虜��������������霈������撌扼��");
		...
		commodityVO1.setE_des("M00002:霈��");
		commodityVO1.setCom_detail("撌典����店隤脩����");
		...
		commodityVO2.setCom_description("�蝷� ��店 雓儔嚗����瘨菔����虜��������������霈������撌扼��");
		...
		commodityVO2.setE_des("M00002:霈��, M00003:����");
		commodityVO1.setCom_detail("撌典����店隤脩����");
...
//		// �閰Ｖ�蝑�
		...
		System.out.print(commodityVO3.getCom_detail() + ", ");
		System.out.println("---------------------");
		...
		for (CommodityVO aCM : list) {
			...
			System.out.print(aCM.getCom_detail() + ", ");
			System.out.println();
		}
	}
	...
	public void insert(CommodityVO commodityVO) {
		...
		try {
			...
			pstmt.setString(11, commodityVO.getCom_detail());
	...
	public void update(CommodityVO commodityVO) {
		...
		try {
			...
			pstmt.setString(12, commodityVO.getCom_detail());
	...
	public CommodityVO findByPrimaryKey(String com_id) {
		...
		try {
			...
			while (rs.next()) {
				...
				commodityVO.setCom_detail(rs.getString("Com_detail"));
