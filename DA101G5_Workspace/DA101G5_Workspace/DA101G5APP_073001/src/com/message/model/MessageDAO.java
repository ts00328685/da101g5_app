...
public class MessageDAO implements MessageDAO_interface{
	...
	// 一個應用程式中,針對一個資料庫 ,共用一個DataSource即可
		...
		private static final String INSERT_STMT = 
				"INSERT INTO message (message_id,member_id,member_id2,message_date,memmsg_ent,memmsg_state) VALUES ('M'||LPAD(to_char(MESSAGE_SEQ.NEXTVAL), ?, ?, ?, ?, ?)";
		...
		private static final String GET_ONE_STMT = 
				"SELECT message_id,member_id,member_id2,to_char(message_date,'yyyy-mm-dd')message_date,memmsg_ent,memmsg_state FROM message where message_id = ?";
