...
//	String passwd = "123456";
	...
	private static final String UPDATE_NUM = "UPDATE member_card_table SET review_time = ?, wrong_number = ?, right_number = ?, choice_card_group = ? "
			+ " where card_id = ? AND member_card_group_id = ?";
...
//		private static final String UPDATE_NUM = "UPDATE member_card_table SET 
//		review_time = ?, wrong_number = ?, right_number = ?, choice_card_group = ? "
//				+ " where card_id = ? AND member_card_group_id = ?";
		try {
...
//			con = DriverManager.getConnection(url, userid, passwd);
			...
			pstmt = con.prepareStatement(UPDATE_NUM);
			
			
			Member_card_tableVO member_card_tableVO = mctDAO.findByPrimaryKey(card_id, member_card_group_id);
			System.out.println("member_card_group_id = " + member_card_group_id );
			System.out.println("card_id = " + card_id);
			System.out.println( member_card_tableVO.toString());
			System.out.println(right_number);
			pstmt.setTimestamp(1, new Timestamp(System.currentTimeMillis()));
			pstmt.setInt(2, member_card_tableVO.getWrong_number() + Integer.valueOf(wrong_number));
			pstmt.setInt(3, member_card_tableVO.getRight_number() + Integer.valueOf(right_number));
			
			pstmt.setInt(4, member_card_tableVO.getChoice_card_group() + Integer.valueOf(choice_card_group));
			pstmt.setString(5, card_id);
			pstmt.setString(6, member_card_group_id);
			
			
			System.out.println("VO.getWrong_number() + wrong_number =" + (member_card_tableVO.getWrong_number() + Integer.valueOf(wrong_number)));
			System.out.println("VO.getRight_number() + right_number =" + ( member_card_tableVO.getRight_number() + Integer.valueOf(right_number)));
			System.out.println("VO.getChoice_card_group() + (choice_card_group) =" + (member_card_tableVO.getChoice_card_group() + Integer.valueOf(choice_card_group)));
