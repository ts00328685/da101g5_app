...
public class FriendFragmentTabFriendList extends Fragment {
    ...
    private FriendFragmentTabFriendList.Course_orderVOAppVOListAdapter course_orderVOAppVOListAdapter;
    ...
    private class Course_orderVOAppVOListAdapter extends RecyclerView.Adapter<FriendFragmentTabFriendList.Course_orderVOAppVOListAdapter.ViewHolder> {
        ...
        @Override
        public FriendFragmentTabFriendList.Course_orderVOAppVOListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cv_buy_teacher_record, parent, false);
            return new FriendFragmentTabFriendList.Course_orderVOAppVOListAdapter.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(FriendFragmentTabFriendList.Course_orderVOAppVOListAdapter.ViewHolder holder, int position) {
            //將資料注入到View裡
