...
public class CardListTabListAllFragment extends Fragment {

    private static final String TAG = "cardTab1";
    ...
    CardListTabListAllFragment.CardVOAppAdapter cardVOAppAdapter;
...
//        List<CardVOApp> cardVOAppList = null;
        ...
        if (cardVOAppList == null || cardVOAppList.isEmpty()) {
            ...
            cardVOAppAdapter = new CardListTabListAllFragment.CardVOAppAdapter(cardVOAppList);
        ...
        card_list_all_tab_fab_choice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("cardVOAppList", jsonIn);
    ...
    private class CardVOAppAdapter extends RecyclerView.Adapter<CardListTabListAllFragment.CardVOAppAdapter.ViewHolder> {
        ...
        @Override
        public CardListTabListAllFragment.CardVOAppAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cv_card, parent, false);
            return new CardListTabListAllFragment.CardVOAppAdapter.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(CardListTabListAllFragment.CardVOAppAdapter.ViewHolder holder, int position) {
            //將資料注入到View裡
            ...
            holder.cv_card_wrongNum.setText(String.valueOf(cardVOApp.getWrong_number()));
